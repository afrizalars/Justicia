...
public class LawyerSearchAdapter extends RecyclerView.Adapter<LawyerSearchAdapter.MyViewHolder>{
    LawyerSearchModel listModel;

    public LawyerSearchAdapter(LawyerSearchModel ModelList) {
        listModel = ModelList;
    }
    ...
    public MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_lawyer_item, parent, false);

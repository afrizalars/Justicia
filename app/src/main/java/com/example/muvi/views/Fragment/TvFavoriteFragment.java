...
import com.example.muvi.adapter.FavoriteTvAdapter;
...
public class TvFavoriteFragment extends Fragment {
    ...
    List<FavoriteTvModel> list = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rv = view.findViewById(R.id.rv_tv_fav);
        rv.setLayoutManager(linearLayoutManager);

        // Setup Realm
        RealmInit realmInit = new RealmInit();
        realmInit.Initialization(getContext());
        list = realmInit.getRealmHelper().getAllFavoriteTv();

        //set recycler view
        adapter = new FavoriteTvAdapter(getContext(), list);
